...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <!-- FIX CSP: Tambah meta tag ini untuk izinin YouTube embed (frame-src) + thumbnail/video -->
        <meta http-equiv="Content-Security-Policy" content="
            ...
            script-src 'self' 'unsafe-inline' https://www.googletagmanager.com https://www.google-analytics.com https://connect.facebook.net https://cdn.jsdelivr.net https://cdnjs.cloudflare.com https://static.cloudflareinsights.com https://pagead2.googlesyndication.com https://clarity.ms https://tags.tiqcdn.com;
            frame-src 'self' https://www.youtube.com https://youtube.com https://www.googletagmanager.com https://www.facebook.com;
            connect-src 'self' https://www.google-analytics.com https://analytics.google.com https://connect.facebook.net https://static.cloudflareinsights.com https://pagead2.googlesyndication.com https://clarity.ms https://tags.tiqcdn.com https://conversion.googleapis.com;
        ">
        ...
        <style>
          ...
          /* pastikan tidak ada perubahan saat hover / active / focus */
          .wa-single-btn:hover,
          .wa-single-btn:active,
          .wa-single-btn:focus {
              background-color: #25D366;
              color: #fff;
              text-decoration: none;
    ...
    <body>
        ...
        @include('section.eight')
        @include('section.ten')
        <div style="background-color: #f2f2f2;">
            @include('section.eleven')
        </div>
        @include('section.twelve')
        <div style="background-color: #f2f2f2;">
            @include('section.thirteen')
        </div>
        ...
        <!-- New Floating WhatsApp Component -->
         <div class="content-wa">
            ...
            <div class="content-wa-main">
                <a href="https://wa.me/62811988190?text=Hi%2C%20saya%20tertarik%20untuk%20tahu%20lebih%20lanjut%20mengenai%20Cognitive%20Assessment%20di%20BrainFit.%20Boleh%20dibantu%20penjelasannya%20lebih%20detail%3F"
                   class="wa-single-btn"
                   data-gtm-event="whatsapp_click"
                   target="_blank"
                   rel="noopener noreferrer">
                    <span>Chat WhatsApp BrainFit</span>
                </a>
